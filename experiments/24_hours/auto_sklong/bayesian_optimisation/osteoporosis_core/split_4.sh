...
# SLURM Configuration
# ========================================
#SBATCH --job-name="24_HOURS_CORE_OSTEOPOROSIS_BO_AUTO_SKLONG_split_4"
#SBATCH --output="24_HOURS_CORE_OSTEOPOROSIS_BO_AUTO_SKLONG_split_4.log"
...
FOLD_NUMBER=5
EXPORT_NAME="24_HOURS_CORE_OSTEOPOROSIS_BO_AUTO_SKLONG"
...
# ========================================
python ./experiments/experiment_launchers/auto_sklong.py --dataset_path $DATASET_PATH --target_column $TARGET_COLUMN --fold_number $FOLD_NUMBER --export_name $EXPORT_NAME
