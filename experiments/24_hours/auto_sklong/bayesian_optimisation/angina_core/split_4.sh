...
# SLURM Configuration
# ========================================
#SBATCH --job-name="24_HOURS_CORE_ANGINA_BO_AUTO_SKLONG_split_4"
#SBATCH --output="24_HOURS_CORE_ANGINA_BO_AUTO_SKLONG_split_4.log"
...
FOLD_NUMBER=4
EXPORT_NAME="24_HOURS_CORE_ANGINA_BO_AUTO_SKLONG"
