...
# SLURM Configuration
# ========================================
#SBATCH --job-name="24_HOURS_DEMENTIA_ASHA_AUTO_SKLONG_split_3"
#SBATCH --output="24_HOURS_DEMENTIA_ASHA_AUTO_SKLONG_split_3.log"
...
FOLD_NUMBER=3
EXPORT_NAME="24_HOURS_DEMENTIA_ASHA_AUTO_SKLONG"
