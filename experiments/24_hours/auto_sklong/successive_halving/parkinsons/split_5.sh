...
# SLURM Configuration
# ========================================
#SBATCH --job-name="24_HOURS_PARKINSONS_ASHA_AUTO_SKLONG_split_5"
#SBATCH --output="24_HOURS_PARKINSONS_ASHA_AUTO_SKLONG_split_5.log"
...
FOLD_NUMBER=5
EXPORT_NAME="24_HOURS_PARKINSONS_ASHA_AUTO_SKLONG"
