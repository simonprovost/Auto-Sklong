...
# SLURM Configuration
# ========================================
#SBATCH --job-name="24_HOURS_CORE_HEARTATTACK_AUTO_SKLEARN_split_1"
#SBATCH --output="24_HOURS_CORE_HEARTATTACK_AUTO_SKLEARN_split_1.log"
...
FOLD_NUMBER=1
EXPORT_NAME="24_HOURS_CORE_HEARTATTACK_AUTO_SKLEARN"
