...
# SLURM Configuration
# ========================================
#SBATCH --job-name="24_HOURS_CORE_OSTEOPOROSIS_AUTO_SKLEARN_split_5"
#SBATCH --output="24_HOURS_CORE_OSTEOPOROSIS_AUTO_SKLEARN_split_5.log"
...
FOLD_NUMBER=5
EXPORT_NAME="24_HOURS_CORE_OSTEOPOROSIS_AUTO_SKLEARN"
...
# ========================================
python ./experiments/experiment_launchers/auto_sklearn.py --dataset_path $DATASET_PATH --target_column $TARGET_COLUMN --fold_number $FOLD_NUMBER --export_name $EXPORT_NAME
