...
# SLURM Configuration
# ========================================
#SBATCH --job-name="24_HOURS_ARTHRITIS_BASELINE_RF_split_2"
#SBATCH --output="24_HOURS_ARTHRITIS_BASELINE_RF_split_2.log"
...
FOLD_NUMBER=2
EXPORT_NAME="24_HOURS_ARTHRITIS_BASELINE_RF"
