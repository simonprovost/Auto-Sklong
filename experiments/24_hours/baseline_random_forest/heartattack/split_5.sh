...
# SLURM Configuration
# ========================================
#SBATCH --job-name="24_HOURS_HEARTATTACK_BASELINE_RF_split_5"
#SBATCH --output="24_HOURS_HEARTATTACK_BASELINE_RF_split_5.log"
...
FOLD_NUMBER=4
EXPORT_NAME="24_HOURS_HEARTATTACK_BASELINE_RF"
