...
# SLURM Configuration
# ========================================
#SBATCH --job-name="24_HOURS_CORE_DIABETES_BASELINE_RF_split_5"
#SBATCH --output="24_HOURS_CORE_DIABETES_BASELINE_RF_split_5.log"
...
FOLD_NUMBER=5
EXPORT_NAME="24_HOURS_CORE_DIABETES_BASELINE_RF"
