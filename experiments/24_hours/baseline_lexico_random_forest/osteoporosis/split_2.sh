...
# SLURM Configuration
# ========================================
#SBATCH --job-name="24_HOURS_OSTEOPOROSIS_BASELINE_LEXICO_RF_split_2"
#SBATCH --output="24_HOURS_OSTEOPOROSIS_BASELINE_LEXICO_RF_split_2.log"
...
DATASET_PATH="../scikit-longitudinal/data/elsa/nurse/csv/osteoporosis_dataset.csv"
TARGET_COLUMN="class_osteoporosis_w8"
FOLD_NUMBER=2
EXPORT_NAME="24_HOURS_OSTEOPOROSIS_BASELINE_LEXICO_RF"
