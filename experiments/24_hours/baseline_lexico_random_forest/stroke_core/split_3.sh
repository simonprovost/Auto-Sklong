...
# SLURM Configuration
# ========================================
#SBATCH --job-name="24_HOURS_CORE_STROKE_BASELINE_LEXICO_RF_split_3"
#SBATCH --output="24_HOURS_CORE_STROKE_BASELINE_LEXICO_RF_split_3.log"
...
DATASET_PATH="../scikit-longitudinal/data/elsa/core/csv/stroke_dataset.csv"
TARGET_COLUMN="class_stroke_w8"
FOLD_NUMBER=1
EXPORT_NAME="24_HOURS_CORE_STROKE_BASELINE_LEXICO_RF"
