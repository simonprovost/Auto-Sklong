...
# SLURM Configuration
# ========================================
#SBATCH --job-name="24_HOURS_CORE_OSTEOPOROSIS_BASELINE_LEXICO_RF_split_4"
#SBATCH --output="24_HOURS_CORE_OSTEOPOROSIS_BASELINE_LEXICO_RF_split_4.log"
...
DATASET_PATH="../scikit-longitudinal/data/elsa/core/csv/osteoporosis_dataset.csv"
TARGET_COLUMN="class_osteoporosis_w8"
FOLD_NUMBER=5
EXPORT_NAME="24_HOURS_CORE_OSTEOPOROSIS_BASELINE_LEXICO_RF"
...
# ========================================
python ./experiments/experiment_launchers/lexico_random_forest.py --dataset_path $DATASET_PATH --target_column $TARGET_COLUMN --fold_number $FOLD_NUMBER --export_name $EXPORT_NAME
