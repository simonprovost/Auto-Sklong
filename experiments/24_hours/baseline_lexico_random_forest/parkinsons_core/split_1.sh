...
# SLURM Configuration
# ========================================
#SBATCH --job-name="24_HOURS_CORE_PARKINSONS_BASELINE_LEXICO_RF_split_1"
#SBATCH --output="24_HOURS_CORE_PARKINSONS_BASELINE_LEXICO_RF_split_1.log"
...
DATASET_PATH="../scikit-longitudinal/data/elsa/core/csv/parkinsons_dataset.csv"
TARGET_COLUMN="class_parkinsons_w8"
FOLD_NUMBER=1
EXPORT_NAME="24_HOURS_CORE_PARKINSONS_BASELINE_LEXICO_RF"
