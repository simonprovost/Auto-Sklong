...
# SLURM Configuration
# ========================================
#SBATCH --job-name="24_HOURS_CORE_DEMENTIA_BASELINE_LEXICO_RF_split_4"
#SBATCH --output="24_HOURS_CORE_DEMENTIA_BASELINE_LEXICO_RF_split_4.log"
...
DATASET_PATH="../scikit-longitudinal/data/elsa/core/csv/dementia_dataset.csv"
TARGET_COLUMN="class_dementia_w8"
FOLD_NUMBER=4
EXPORT_NAME="24_HOURS_CORE_DEMENTIA_BASELINE_LEXICO_RF"
