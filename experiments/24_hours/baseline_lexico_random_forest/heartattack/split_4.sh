...
# SLURM Configuration
# ========================================
#SBATCH --job-name="24_HOURS_HEARTATTACK_BASELINE_LEXICO_RF_split_4"
#SBATCH --output="24_HOURS_HEARTATTACK_BASELINE_LEXICO_RF_split_4.log"
...
DATASET_PATH="../scikit-longitudinal/data/elsa/nurse/csv/heartattack_dataset.csv"
TARGET_COLUMN="class_heartattack_w8"
FOLD_NUMBER=4
EXPORT_NAME="24_HOURS_HEARTATTACK_BASELINE_LEXICO_RF"
