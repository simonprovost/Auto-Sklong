...
# SLURM Configuration
# ========================================
#SBATCH --job-name="24_HOURS_CORE_CATARACT_BASELINE_LEXICO_RF_split_5"
#SBATCH --output="24_HOURS_CORE_CATARACT_BASELINE_LEXICO_RF_split_5.log"
...
DATASET_PATH="../scikit-longitudinal/data/elsa/core/csv/cataract_dataset.csv"
TARGET_COLUMN="class_cataract_w8"
FOLD_NUMBER=5
EXPORT_NAME="24_HOURS_CORE_CATARACT_BASELINE_LEXICO_RF"
