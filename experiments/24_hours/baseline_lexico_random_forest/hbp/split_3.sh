...
# SLURM Configuration
# ========================================
#SBATCH --job-name="24_HOURS_HBP_BASELINE_LEXICO_RF_split_3"
#SBATCH --output="24_HOURS_HBP_BASELINE_LEXICO_RF_split_3.log"
...
DATASET_PATH="../scikit-longitudinal/data/elsa/nurse/csv/hbp_dataset.csv"
TARGET_COLUMN="class_hbp_w8"
FOLD_NUMBER=3
EXPORT_NAME="24_HOURS_HBP_BASELINE_LEXICO_RF"
